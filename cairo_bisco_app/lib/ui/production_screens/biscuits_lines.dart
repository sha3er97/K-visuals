                          ...
                          return FutureBuilder<QuerySnapshot>(
                            ...
                            builder: (BuildContext context,
                              ...
                              if (downTimeSnapshot.hasError) {
                                ...
                                List<QueryDocumentSnapshot<OverWeightReport>>
                                    reportsList = overweightSnapshot.data!.docs
                                        as List<
                                            QueryDocumentSnapshot<
                                                OverWeightReport>>;
                                OverWeightReport overWeight1 = OverWeightReport
                                    .getFilteredReportOfInterval(
                                  reportsList,
                                  int.parse(from_month),
                                  int.parse(to_month),
                                ...
                                OverWeightReport overWeight2 = OverWeightReport
                                    .getFilteredReportOfInterval(
                                  reportsList,
                                  int.parse(from_month),
                                  int.parse(to_month),
                                ...
                                OverWeightReport overWeight3 = OverWeightReport
                                    .getFilteredReportOfInterval(
                                  reportsList,
                                  int.parse(from_month),
                                  int.parse(to_month),
                                ...
                                OverWeightReport overWeight4 = OverWeightReport
                                    .getFilteredReportOfInterval(
                                  reportsList,
                                  int.parse(from_month),
                                  int.parse(to_month),
