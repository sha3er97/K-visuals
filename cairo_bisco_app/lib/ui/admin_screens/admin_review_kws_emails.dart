...
class ReviewKwsEmails extends StatefulWidget {
  @override
  _ReviewKwsEmailsState createState() => _ReviewKwsEmailsState();
}

class _ReviewKwsEmailsState extends State<ReviewKwsEmails> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                            ...
                            padding: const EdgeInsets.all(minimumPadding),
                            itemCount: Credentials.kws_emails.length,
                            itemBuilder: (BuildContext context, int index) {
                              return ListTile(
                                title:
                                    adminHeading(Credentials.kws_emails[index]),
                                leading: IconButton(
                                  icon: const Icon(Icons.close),
                                  color: KelloggColors.cockRed,
                                  onPressed: () {
                                    confirmDeleteKwsAlertDialog(
                                        context, Credentials.kws_emails[index]);
                                  },
                                ),
                                // leading: deleteBtn(
